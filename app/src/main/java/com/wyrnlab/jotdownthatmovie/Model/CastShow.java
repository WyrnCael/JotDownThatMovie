...
public class CastShow extends AudiovisualInterface implements Serializable {

    public void setDataFromJson(ModelCastShow cast){
        super.TituloOriginal = cast.original_name;
        super.Titulo = cast.name;
        super.Id = cast.id;
