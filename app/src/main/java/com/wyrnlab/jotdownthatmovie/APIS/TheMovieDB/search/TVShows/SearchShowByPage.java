...
public class SearchShowByPage extends AsyncTask<String, Integer, List<TVShow>> {
    ...
    public SearchShowByPage(Context context, Integer page){
    ...
    public List<TVShow> buscar(String nombre)  throws IOException {
        ...
        String url = General.URLPRINCIPAL + "3/search/tv?api_key=" + General.APIKEY + "&language=" + SetTheLanguages.getLanguage(Locale.getDefault().getDisplayLanguage()) + "&query=" + URLEncoder.encode(nombre) + "&page=" + this.page ;
