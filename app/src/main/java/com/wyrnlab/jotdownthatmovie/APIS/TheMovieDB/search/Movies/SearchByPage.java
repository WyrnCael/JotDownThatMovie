...
public class SearchByPage extends AsyncTask<String, Integer, List<Pelicula>> {
    ...
    public SearchByPage(Context context, Integer page){
    ...
    public List<Pelicula> buscar(String nombre)  throws IOException {
        ...
        String url = General.URLPRINCIPAL + "3/search/movie?api_key=" + General.APIKEY + "&language=" + SetTheLanguages.getLanguage(Locale.getDefault().getDisplayLanguage()) + "&query=" + URLEncoder.encode(nombre) + "&page=" + this.page ;
